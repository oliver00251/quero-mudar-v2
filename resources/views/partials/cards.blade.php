    ...
    <div class="col-md-4">
        <div class="card card-custom total-card text-center">
            <div class="card-body">
                ...
                <p class="card-text money">€ {{ number_format($total_geral, 2, ',', '.') }}</p>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card card-custom entradas-card text-center">
            <div class="card-body">
                ...
                <p class="card-text money">€ {{ number_format($total_entradas, 2, ',', '.') }}</p>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card card-custom saidas-card text-center">
            <div class="card-body">
                ...
                <p class="card-text money">€ {{ number_format($total_saidas, 2, ',', '.') }}</p>
            </div>
        </div>
    </div>
</div>
